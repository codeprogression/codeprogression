...
namespace AdventureWorks
{
	...
	{	   
        ...
        /// </summary>
        /// <returns>TransactionHistoryArchiveCollection</returns>
		public TransactionHistoryArchiveCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                TransactionHistoryArchive o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class TransactionHistoryArchive : ActiveRecord<TransactionHistoryArchive>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("TransactionHistoryArchive", TableType.Table, DataService.GetInstance("AdventureWorks"));
				...
				DataService.Providers["AdventureWorks"].AddSchema("TransactionHistoryArchive",schema);
			}
		}
		#endregion
