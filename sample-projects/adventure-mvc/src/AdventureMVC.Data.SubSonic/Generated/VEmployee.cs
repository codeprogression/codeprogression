...
namespace AdventureWorks{
    ...
    /// </summary>
    [Serializable]
    public partial class VEmployee : ReadOnlyRecord<VEmployee>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vEmployee", TableType.View, DataService.GetInstance("AdventureWorks"));
                ...
                DataService.Providers["AdventureWorks"].AddSchema("vEmployee",schema);
            }
        }
        #endregion
