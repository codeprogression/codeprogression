...
namespace AdventureWorks
{
	...
	{	   
        ...
        /// </summary>
        /// <returns>ProductCostHistoryCollection</returns>
		public ProductCostHistoryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ProductCostHistory o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class ProductCostHistory : ActiveRecord<ProductCostHistory>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProductCostHistory", TableType.Table, DataService.GetInstance("AdventureWorks"));
				...
				DataService.Providers["AdventureWorks"].AddSchema("ProductCostHistory",schema);
			}
		}
		#endregion
