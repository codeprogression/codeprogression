...
namespace AdventureWorks{
    ...
    /// </summary>
    [Serializable]
    public partial class VIndividualCustomer : ReadOnlyRecord<VIndividualCustomer>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vIndividualCustomer", TableType.View, DataService.GetInstance("AdventureWorks"));
                ...
                DataService.Providers["AdventureWorks"].AddSchema("vIndividualCustomer",schema);
            }
        }
        #endregion
