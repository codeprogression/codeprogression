...
namespace AdventureWorks{
    ...
    /// </summary>
    [Serializable]
    public partial class VEmployeeDepartmentHistory : ReadOnlyRecord<VEmployeeDepartmentHistory>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vEmployeeDepartmentHistory", TableType.View, DataService.GetInstance("AdventureWorks"));
                ...
                DataService.Providers["AdventureWorks"].AddSchema("vEmployeeDepartmentHistory",schema);
            }
        }
        #endregion
