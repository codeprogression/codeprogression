...
namespace AdventureWorks
{
	...
	{	   
        ...
        /// </summary>
        /// <returns>ProductListPriceHistoryCollection</returns>
		public ProductListPriceHistoryCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                ProductListPriceHistory o = this[i];
	...
	/// </summary>
	[Serializable]
	public partial class ProductListPriceHistory : ActiveRecord<ProductListPriceHistory>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("ProductListPriceHistory", TableType.Table, DataService.GetInstance("AdventureWorks"));
				...
				DataService.Providers["AdventureWorks"].AddSchema("ProductListPriceHistory",schema);
			}
		}
		#endregion
