...
namespace AdventureWorks{
    ...
    /// </summary>
    [Serializable]
    public partial class VSalesPerson : ReadOnlyRecord<VSalesPerson>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vSalesPerson", TableType.View, DataService.GetInstance("AdventureWorks"));
                ...
                DataService.Providers["AdventureWorks"].AddSchema("vSalesPerson",schema);
            }
        }
        #endregion
