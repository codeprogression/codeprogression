...
!define PRODUCT_NAME "Flash Card Master"
...
VIAddVersionKey LegalCopyright "© 2007 ${PRODUCT_PUBLISHER}"
...
Section "!Application" SEC01
  ...
  DetailPrint "Compiling native assemblies..."
  ; get directory of .NET framework installation
	Push "v2.0"
	Call GetDotNetDir
	Pop $R0 ; .net framework v2.0 installation directory
		
  nsExec::ExecToLog /OEM /TIMEOUT=60000 '$R0\ngen install "$INSTDIR\${PRODUCT_EXECUTABLE}"'
...
Section Uninstall
  ...
  DetailPrint "Removing native assemblies..."
  ; get directory of .NET framework installation
	Push "v2.0"
	Call un.GetDotNetDir
	Pop $R0 ; .net framework v2.0 installation directory
		
  nsExec::ExecToLog /OEM /TIMEOUT=60000 '$R0\ngen uninstall "${PRODUCT_EXECUTABLE_WOEXT}"'
